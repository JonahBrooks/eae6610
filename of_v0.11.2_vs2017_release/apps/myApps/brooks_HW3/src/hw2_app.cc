...
brooks_hw3::DynamicSteeringOutput LookInDirectionOfTravel(brooks_hw3::AiAgent agent) {
...
void Hw2App::MakeWallAndEditEdges(size_t x, size_t y, size_t width, size_t height) {
